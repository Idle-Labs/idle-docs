---
description: Products > Perpetual Yield Tranches > Overview > AYS
---

# Adaptive Yield Split

> The Adaptive Yield Split is a unique feature of PYTs that manages the return distribution dynamically conditional to the liquidity deposited on each side (Senior/Junior) of the Tranche.
